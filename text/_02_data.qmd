...
For Housing Price Data, the Residential Property Price Dataset from the Bank of International Settlement is used [@scatignaResidentialPropertyPrice2014]. The dataset is widely used in cross country comparisons [i.e. @runstlerBusinessHousingCredit2018] and includes quarterly time series for most developed countries in real terms. 
