...
To adress this, the panel regression is extended with a mean group estimator. This estimator allows for heterogeneity in individual coefficients and averages them to obtain a common parameter estimate [@pesaranEstimatingLongrunRelationships1995]. **XX**  Time Fixed Effects are included in the computations by use of a demeaned mean group estimator [@coakleyUnobservedHeterogeneityPanel2006]. **XX** 
