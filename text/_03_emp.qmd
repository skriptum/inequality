...
Excluding the Netherlands slightly reduces the magnitude of the coefficients for house prices in the upper half of the distribution, but the signs and significance remain stable. For the top 10%, the negative effect of house prices weakens from -0.057 to -0.069, while for the middle 40%, the positive effect increases slightly and becomes more statistically significant.
