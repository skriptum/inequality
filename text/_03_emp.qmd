...
The results also enable the calculation of the approximate ratio of house price growth to stock price growth needed to maintain a stable top decile share[^e2]. The estimated ratio to fulfill this condition equals 4.46. This implies that house prices would need to grow more than four times as fast as stock prices to keep the top 10% wealth share constant. 
