...
### Appendix A: Housing Wealth across Europe {.unnumbered}

![Housing wealth as share of total net wealth](../output/desc/map.png){#fig-map}
...
### Appendix B: Descriptive Table {.unnumbered}
...
```{=html}
{{< include ../output/appendix/table_descriptive.html >}}
```
...
### Appendix C: Portfolio and Asset Distribution across Europe {.unnumbered}
...
```{=html}
{{< include ../output/paneltables/dynamic.html >}}
```
...
::: {.content-visible when-format="html"}
```{=html}
{{< include ../output/ts_tables/ts_T10.html >}}
```
:::
...
::: {.content-visible when-format="html"}
```{=html}
{{< include ../output/ts_tables/ts_M40.html >}}
```
:::
...
::: {.content-visible when-format="html"}
```{=html}
{{< include ../output/ts_tables/ts_B50.html >}}
```
:::
