...
A key limitation of the DWA is that it does not differentiate between the price and quantity effects when measuring housing wealth. An increase could be driven by changes the valuation of the existing stock as well as an expansion in the stock of houses independent of their valuation. This would influence the measurement of housing wealth as well as total wealth and could bias interpretations of inequality dynamics if the underlying drivers are not solely price-based.

If the quantity effect would be the main driver of the wealth, this would result in a large increase in the stock of houses as well as an increase in home ownership rates. While there is a marginal increase in the number of dwellings per inhabitant in most european countries between 2011 and 2022 [@OECDAffordableHousing2024], home ownership rates remained stable. The eurozone average moved from 66.6% in 2011 to 65.8% in 2021, reaching a high of 66.9% in 2012 [@eurostatDistributionPopulationTenure2024]. This pattern is inconsistent with a quantity-driven explanation. Instead, the stability in homeownership suggests that rising housing wealth reflects valuation effects. 
